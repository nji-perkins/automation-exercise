...
describe('Web Application Tests', () => {
  it('User can create an account and make a purchase', () => {
    ...
    cy.get('[data-qa="days"]').select('10', { delay: 100 });
    cy.get('[data-qa="months"]').select('May', { delay: 100 });
    cy.get('[data-qa="years"]').select('1990', { delay: 100 });
    cy.get('#newsletter').check();
    cy.get('#optin').check();
    cy.get('[data-qa="first_name"]').type('John', { delay: 100 });
    cy.get('[data-qa="last_name"]').type('Doe', { delay: 100 });
    cy.get('[data-qa="company"]').type('ABC Company', { delay: 100 });
    cy.get('[data-qa="address"]').type('123 Main St', { delay: 100 });
    cy.get('[data-qa="address2"]').type('Apt 4B', { delay: 100 });
    cy.get('[data-qa="country"]').select('Canada', { delay: 100 });
    cy.get('[data-qa="state"]').type('Ontario', { delay: 100 });
    cy.get('[data-qa="city"]').type('Toronto', { delay: 100 });
